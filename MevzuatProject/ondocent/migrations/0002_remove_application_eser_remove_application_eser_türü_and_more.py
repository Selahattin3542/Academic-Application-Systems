...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='application',
            name='eser1',
            field=models.FileField(default='default_eser1.pdf', upload_to='eserler/', verbose_name='Başlıca Eser 1'),
        ),
        migrations.AddField(
            model_name='application',
            name='eser2',
            field=models.FileField(default='default_eser2.pdf', upload_to='eserler/', verbose_name='Başlıca Eser 2'),
        ),
        migrations.AddField(
            model_name='application',
            name='eser_türü1',
        ...
        migrations.AddField(
            model_name='application',
            name='eser_türü2',
            field=models.CharField(choices=[('A-1a', 'A-1a'), ('A-1b', 'A-1b'), ('A-2a', 'A-2a'), ('C-1', 'C-1')], default='A1-a', max_length=10, verbose_name='Eser Türü 2'),
        ),
        migrations.AddField(
            model_name='application',
            name='sözlü',
